        ...
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror"
                                  id="content" name="content" rows="4">{{ old('content', $event->content) }}</textarea>
                        @error('content')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row time-fields" style="{{ old('is_all_day', $event->is_all_day) ? 'display:none;' : '' }}">
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="recurrence-fields" style="{{ old('is_recurring', $event->is_recurring) ? '' : 'display:none;' }}">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('recurrence_rule') is-invalid @enderror"
                                ...
                                <option value="daily" {{ old('recurrence_rule', $event->recurrence_rule) == 'daily' ? 'selected' : '' }}>Diariamente</option>
                                <option value="weekly" {{ old('recurrence_rule', $event->recurrence_rule) == 'weekly' ? 'selected' : '' }}>Semanalmente</option>
                                <option value="monthly" {{ old('recurrence_rule', $event->recurrence_rule) == 'monthly' ? 'selected' : '' }}>Mensualmente</option>
                                <option value="yearly" {{ old('recurrence_rule', $event->recurrence_rule) == 'yearly' ? 'selected' : '' }}>Anualmente</option>
                            </select>
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('icon') is-invalid @enderror"
                               id="icon" name="icon" value="{{ old('icon', $event->icon) }}" placeholder="fas fa-calendar">
            ...
            <div class="card mb-4">
                <div class="card-body small text-muted">
                    <div><strong>Creado:</strong> {{ $event->created_at->format('d/m/Y H:i') }}</div>
                    <div><strong>Actualizado:</strong> {{ $event->updated_at->format('d/m/Y H:i') }}</div>
                    @if($event->creator)
                        <div><strong>Creado por:</strong> {{ $event->creator->name }}</div>
                    @endif
                </div>
            </div>
