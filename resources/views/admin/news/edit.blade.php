                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror"
                                  id="content" name="content" rows="3" required maxlength="500">{{ old('content', $news->content) }}</textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('expires_at') is-invalid @enderror"
                                   id="expires_at" name="expires_at" value="{{ old('expires_at', $news->expires_at ? $news->expires_at->format('Y-m-d\TH:i') : '') }}">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input type="checkbox" class="form-check-input" id="priority" name="priority" value="1"
                                {{ old('priority', $news->priority > 0) ? 'checked' : '' }}>
